...
if (mysqli_num_rows($forum_result) == 0) {
    ...
    echo "<meta http-equiv='Refresh' content='0; url=student_forums.php'>";
    exit;
}
                ...
                <div class="card mb-4 shadow-sm question-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h5 class="card-title">
                                <a href="student_show_question_details.php?question_id=<?php echo $question['id']; ?>">
                    ...
                    <div class="card-footer bg-white">
                        <a href="student_show_question_details.php?question_id=<?php echo $question['id']; ?>" class="btn btn-outline-primary btn-sm">
