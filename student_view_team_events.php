...
$check_query = "SELECT * FROM team_membership WHERE team_id = '$team_id' AND user_id = '$user_id' AND status = 'approved'";
$check_result = mysqli_query($con, $check_query);

if (mysqli_num_rows($check_result) != 1) {
    echo "<script>alert('You do not have access to this team\\'s events');</script>";
    echo "<meta http-equiv='Refresh' content='0; url=student_my_memberships.php'>";
    exit;
}
        ...
        <div class="col-md-12">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <?php if ($is_leader || true) { // All approved members can add events ?>
                        <a href="student_add_event.php?team_id=<?php echo $team_id;?>" class="btn btn-light">
